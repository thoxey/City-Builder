...
export interface Repo {
  ...
  // Reads + parses an arbitrary repo-relative JSON file. Used to refresh
  // manifest entries from their on-disk source — the cached manifest is
  // regenerated by Godot's editor plugin and goes stale after every web-side
  // save. Optional: download-mode has no per-file access.
